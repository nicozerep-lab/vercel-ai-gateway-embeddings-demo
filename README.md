...
1. Pull environment variables with `vc env pull`
   - If you prefer managing secrets manually, copy `.env.example` to `.env.local` and fill in your own values. This file is git-ignored so you can keep credentials out of version control.
